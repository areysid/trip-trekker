...
// import { getChatSession } from "@/service/AIModel"; // adjust the path if needed
...
//     const chatSession = await getChatSession(); // This gets you the session
//     const result = await chatSession.sendMessage(FINAL_PROMPT); //  Send the prompt
//     const responseText = await result.response.text(); //  Get the actual text response
...
//     // Sanitize the formData to remove or convert unsupported fields
//     const sanitizedFormData = {
//       ...formData,
//       place: formData.place
//         ? {
//             formatted_address: formData.place.formatted_address || null, // Use null if undefined
//             place_id: formData.place.place_id || null, // Use null if undefined
//             name: formData.place.name || null, // Use null if undefined
//             geometry: formData.place.geometry
//               ? {
//                   location: {
//                     lat: formData.place.geometry.location?.lat?.() || null, // Safely access lat
//                     lng: formData.place.geometry.location?.lng?.() || null, // Safely access lng
//                   },
//                 }
//               : null, // Use null instead of undefined
//           }
//         : null, // Use null if place is undefined
//     };
...
//         userEmail: user?.email || null, // Ensure user.email is not undefined
//         id: docId,
//       });
...
//         </div>
//         <div>
//           <h2 className="text-xl my-3 font-medium mt-15">
